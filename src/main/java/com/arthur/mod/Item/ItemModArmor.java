...
public class ItemModArmor extends ItemArmor
{
    ...
    {
        if(repair.getItem() == ItemsMod.amazoniteHelmet || repair.getItem() == ItemsMod.amazoniteitem || repair.getItem() == ItemsMod.amazoniteChestplate || repair.getItem() == ItemsMod.amazoniteLeggings || repair.getItem() == ItemsMod.amazoniteBoots)
        {
            return true;
        }
        return false;
